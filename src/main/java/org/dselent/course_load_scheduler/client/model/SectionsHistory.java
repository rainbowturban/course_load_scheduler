...
public class SectionsHistory extends Model{
	// attributes
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof SectionsHistory)) {
			return false;
		}
		SectionsHistory other = (SectionsHistory) obj;
		if (coursesID == null) {
	...
	public String toString() {
		return "SectionsHistory [id=" + id + ", name=" + name + ", crn=" + crn + ", termsID=" + termsID
				+ ", sectionTypeID=" + sectionTypeID + ", daysID=" + daysID + ", coursesID=" + coursesID
				+ ", startID=" + startID + ", endID=" + endID + ", createdAt=" + createdAt + ", updatedAt="
